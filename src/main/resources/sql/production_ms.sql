...
Source Database       : production_ms

Target Server Type    : MYSQL
Target Server Version : 50617
File Encoding         : 65001

Date: 2016-12-22 21:15:56
*/
...
INSERT INTO `custom` VALUES ('007', '百度', '北京百度有限公司', '北京海淀区中关村软件园二期百度科技园', '156151', '561455@baidu.com', '李彦宏', '15615615', '1', 'fafsaga');
...
INSERT INTO `c_order` VALUES ('000004', '002', '00003', '2016-10-07 00:00:00', '2016-10-07 00:00:00', '<h1 style=\"text-align:center;\">\r\n	<b><span style=\"font-size:16px;\">产品验收标准</span></b> \r\n</h1>\r\n<p class=\"MsoNormal\" align=\"left\">\r\n	1，桌子承重测试<span style=\"color:#E53333;\">50KGS,&nbsp;2&nbsp;HOURS&nbsp;</span>以上，无任何缺陷发生&nbsp;\r\n</p>\r\n<p class=\"MsoNormal\" align=\"left\">\r\n	2，桌子侧翻测试，在离桌子边缘5CM的地方施加30KGS一垂直向下的力，检查产品是否会翻倒，或用人的双手做此动作，看是否会翻倒&nbsp;\r\n</p>\r\n<p class=\"MsoNormal\" align=\"left\">\r\n	3，平稳性测试，将产品放置余一水平地面上，测试其平稳性，桌腿误差不能大于<span style=\"color:#E53333;\">5MM</span>间隙。\r\n</p>\r\n<p class=\"MsoNormal\" align=\"left\">\r\n	4，提起桌子的一边，与地面成20度角，然后自由落地，检查产品结构、桌脚是否有问题&nbsp;\r\n</p>\r\n<p class=\"MsoNormal\" align=\"left\">\r\n	5，按照说明书安装步骤进行组装，检查产品各部件是否组装顺畅，配合良好&nbsp;\r\n</p>\r\n<p class=\"MsoNormal\" align=\"left\">\r\n	6,对于木制品，检验时，请注意木制品表面不能有虫孔，产品正面不能有死结，木头不能开裂，黑线，补土良好，补土颜色不能与产品有太明显之色差。&nbsp;\r\n</p>\r\n<p class=\"MsoNormal\" align=\"left\">\r\n	7,&nbsp;验货时QC要自行做组装测试，注意清点配件切不可缺少。\r\n</p>\r\n<p class=\"MsoNormal\" align=\"left\">\r\n	8,室内产品湿度10+-2，室外产品湿度：12+-2.&nbsp;\r\n</p>', '156', '220.00', '元', null, '/file/产品购销合同.docx', '1');
INSERT INTO `c_order` VALUES ('000006', '003', '00004', '2016-12-01 00:00:00', '2016-12-01 00:00:00', '发发发嘎嘎1', '132', '12.00', '元', '/pic/1480583501010783.jpg,', '/file/购销合同 - 副本 (2).doc', '1');
INSERT INTO `c_order` VALUES ('000007', '002', '00004', '2016-12-20 00:00:00', '2016-12-20 00:00:00', null, null, null, '元', '/pic/1482198277589281.jpg,', null, '1');
INSERT INTO `c_order` VALUES ('000008', '002', '00005', '2016-12-20 00:00:00', '2016-12-21 00:00:00', '发发<span style=\"color:#E53333;\">看见</span>', '3132', '323.00', '美元', '/pic/1482285484827014.jpg,', '/file/产品购销合同011(1).docx', '2');
INSERT INTO `c_order` VALUES ('000009', '002', '00001', '2016-09-28 00:00:00', '2016-09-28 00:00:00', '<h2>\r\n	<span style=\"color:#E53333;\">该订单要在11月5号之前完成</span> \r\n</h2>', '111', '888.00', '元', '/pic/1477451298385009.jpg,/pic/1477451298442216.jpg', '/file/产品购销合同2.docx,/file/购销合同 - 副本 (2).doc', '1');
...
INSERT INTO `c_order` VALUES ('000011', '001', '00006', '2016-09-30 00:00:00', '2016-09-30 00:00:00', '<h1>\r\n	<strong><em>这是一个订单</em></strong> \r\n</h1>', '4324', '23.00', '元', null, '/file/聘书(2016-10-07).ppt,/file/网页源代码(2016-10-07).txt', '2');
...
INSERT INTO `c_order` VALUES ('000014', '001', '00004', '2016-12-04 00:00:00', '2016-12-04 00:00:00', null, null, '9.00', '元', null, null, '1');
INSERT INTO `c_order` VALUES ('000015', '002', '00005', '2016-12-03 00:00:00', '2016-12-03 00:00:00', null, null, null, '元', null, null, '1');
...
INSERT INTO `department` VALUES ('006', '物流部', '负责公司物流调配。');
INSERT INTO `department` VALUES ('007', '礼仪部', '负责前台接待及会务礼仪。');
INSERT INTO `department` VALUES ('3213', '保安部', '保卫安全。');
...
-- Records of device
-- ----------------------------
INSERT INTO `device` VALUES ('001', '焊接设备', '01', '1', '良好', '2016-08-08 08:08:01', '99.99', '2016-09-09 09:09:01', '2021-09-09 09:09:01', '002', '状态良好');
...
-- ----------------------------
INSERT INTO `device_check` VALUES ('001', '001', '002', '2016-07-06 08:08:08', 'Ok。', '无');
...
INSERT INTO `device_check` VALUES ('321', '001', '001', '2016-12-21 11:05:20', null, '321');
...
-- ----------------------------
INSERT INTO `device_maintain` VALUES ('001', '001', '001', '2016-10-07 08:08:08', '维修成功', '88.88', '维修成功.');
...
INSERT INTO `device_type` VALUES ('07', '装载设备', '大', 'A', '厦门天德设备有限公司', '湖南三一重工', '5', '2016-12-19 15:30:30');
INSERT INTO `device_type` VALUES ('3213', '检验设备', '小', 'A', '厦门蓝天检验设备公司', '厦门蓝天检验设备公司', '20', '2016-12-21 11:03:59');
...
INSERT INTO `employee` VALUES ('002', '张三', '1', '152346842123458618', '1970-01-01', '1970-01-01', '在职', '大专', '无', '软件工程', null, '全日制', '001');
...
INSERT INTO `final_count_check` VALUES ('54791', '000008', '菌落数', '3', '3', '6', '0.89', '2015-05-13 00:00:00', '6', '001', '良', '问题较多，需要重审');
...
-- ----------------------------
INSERT INTO `final_measuret_check` VALUES ('11022', '000003', '材料', '2015-05-13 00:00:00', '36m', '001', '优', '合格率高，做工精致a');
...
-- ----------------------------
INSERT INTO `manufacture` VALUES ('0001', '000001', '001', '15', '2016-10-27 09:23:01', '2016-10-28 09:23:05');
...
INSERT INTO `manufacture` VALUES ('0005', '000007', '002', '32', '2016-12-13 21:46:07', '2016-12-13 21:46:12');
INSERT INTO `manufacture` VALUES ('0006', '000004', '002', '1', '2016-12-20 00:00:00', '2016-12-20 00:00:00');
INSERT INTO `manufacture` VALUES ('0007', '000002', '002', '143', '2016-12-21 00:00:00', '2016-12-21 00:00:00');
...
-- Records of material
-- ----------------------------
INSERT INTO `material` VALUES ('BZ3004985112', '包装类', '充足', '50', '用于保护和指导产品使用的物品.');
...
INSERT INTO `material_consume` VALUES ('A1561810', '001', 'GM3587100823', '45', '2016-11-13 00:00:00', '齐鲁钢铁公司', '朝阳钢铁公司', '进口矿石');
...
-- ----------------------------
INSERT INTO `material_receive` VALUES ('1561515', 'BZ3004985112', '15', '2016-12-20 00:00:00', '天猫', '货运公司', '账款已结清。');
INSERT INTO `material_receive` VALUES ('B1087893', 'RJ10033214-80', '21', '2016-12-03 00:00:00', '齐鲁钢铁公司', '朝阳钢铁公司', '粉矿3.67');
...
INSERT INTO `process` VALUES ('04', '001', '3', '3');
...
INSERT INTO `process_count_check` VALUES ('36124', '03', '电话机', '6', '4', '8', '0.88', '2015-05-13 00:00:00', '12', '001', '优秀', '产品质量过关，外表美观');
...
INSERT INTO `process_count_check` VALUES ('36894', '03', '茶杯', '6', '4', '8', '0.88', '2015-05-13 00:00:00', '12', '001', '优秀', '产品质量过关，外表美观');
INSERT INTO `process_count_check` VALUES ('96124', '03', '柜子', '6', '4', '8', '0.88', '2015-05-13 00:00:00', '12', '001', '优秀', '产品质量过关，外表美观');
...
-- ----------------------------
INSERT INTO `process_measure_check` VALUES ('321', '03', '321', '2016-12-22 00:00:00', '213', '003', '3213321', '<h1>\r\n	31232132133213<span style=\"color:#E53333;\"></span>\r\n</h1>');
INSERT INTO `process_measure_check` VALUES ('73689', '03', '耗时', '2015-05-13 00:00:00', '37件', '001', '延时', '工序复杂，耗时1');
INSERT INTO `process_measure_check` VALUES ('79619', '03', '产品合格率', '2015-05-13 00:00:00', '37件', '001', '延时', '工序复杂，耗时');
INSERT INTO `process_measure_check` VALUES ('79689', '03', '工人工时', '2015-05-13 00:00:00', '37件', '001', '延时', '工序复杂，耗时');
...
INSERT INTO `product` VALUES ('00002', '壁挂音箱', '电子设备', '/pic/1482319916209646.png,', '<p class=\"MsoNormal\" style=\"text-indent:24.0000pt;\">\r\n	<span>壁挂音箱</span> EAW SMS4\r\n</p>\r\n<p class=\"MsoNormal\" align=\"center\" style=\"text-indent:24.0000pt;text-align:center;\">\r\n	&nbsp;\r\n</p>\r\n<p class=\"MsoNormal\" style=\"margin-left:36pt;text-indent:24pt;\">\r\n	•&nbsp;130mm 高效率低频单元\r\n</p>\r\n<p class=\"MsoNormal\" style=\"margin-left:36pt;text-indent:24pt;\">\r\n	•&nbsp;0.5″球顶高音, 恒定指向号角负载\r\n</p>\r\n<p class=\"MsoNormal\" style=\"margin-left:36pt;text-indent:24pt;\">\r\n	•&nbsp;内置多抽头定压变压器\r\n</p>\r\n<p class=\"MsoNormal\" style=\"margin-left:36pt;text-indent:24pt;\">\r\n	•&nbsp;内置低阻抗分频器\r\n</p>\r\n<p class=\"MsoNormal\" style=\"margin-left:36pt;text-indent:24pt;\">\r\n	•&nbsp;重量轻、耐各种气候的高密度聚苯乙烯箱体，适合多种用途，具有隐蔽性\r\n</p>\r\n<p class=\"MsoNormal\" style=\"margin-left:36pt;text-indent:24pt;\">\r\n	•&nbsp;箱体具有安装点，配有安装支架，易于安装\r\n</p>\r\n<p class=\"MsoNormal\" style=\"margin-left:36pt;text-indent:24pt;\">\r\n	•&nbsp;黑白两种颜色可供选择\r\n</p>', '1');
...
INSERT INTO `sys_role` VALUES ('002', '用户管理员', '2');
INSERT INTO `sys_role` VALUES ('003', '订单管理员', '1');
...
-- ----------------------------
INSERT INTO `sys_role_permission` VALUES ('1456115611515', '002', '201,202,203,');
INSERT INTO `sys_role_permission` VALUES ('147729449886163', '15615615151', '11,12,13,231,232,233,271,273,');
INSERT INTO `sys_role_permission` VALUES ('147737863632731', '005', '31,81,83,121,131,133,172,252,51,53,');
INSERT INTO `sys_role_permission` VALUES ('148007157091762', '004', '181,183,193,221,222,223,');
...
INSERT INTO `sys_user_role` VALUES ('147705484492576', '003', '003');
...
-- Records of task
-- ----------------------------
INSERT INTO `task` VALUES ('001', '0001', '001', '112', '700');
INSERT INTO `task` VALUES ('002', '0001', '001', '213', '221');
INSERT INTO `task` VALUES ('003', '0003', '003', '15', '15');
...
-- ----------------------------
INSERT INTO `technology` VALUES ('001', '打磨精加工', '33.00', '333', '333', '333', '666', '1200', '1400');
...
INSERT INTO `technology_plan` VALUES ('005', '001', '321', '2016-12-12 11:12:30', '2016-12-15 11:12:34', '2016-12-21 11:12:36', null, null);
...
INSERT INTO `technology_requirement` VALUES ('07', '002', '321321321', '2016-12-06 11:10:12', '2016-12-22 11:10:15');
...
INSERT INTO `unqualify_apply` VALUES ('0002', '00005', '平整度', '5', '2015-05-13 00:00:00', '001', '2015-05-13 00:00:00', '需要返厂');
...
INSERT INTO `work` VALUES ('004', '2', '00002', '03', '004', '15');
INSERT INTO `work` VALUES ('005', '3', '00002', '02', '005', '16');
INSERT INTO `work` VALUES ('321321', '321321', '00003', '02', '002', '432');
